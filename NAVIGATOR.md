...
Create a YAML configuration file for your application:
...
Managed processes are configured in the YAML configuration file:
...
- **Dynamic reloads**: Restart navigator with updated configuration
...
### Rails Integration
- **PIDFILE Support**: Configured for each tenant in standard_vars
- **Environment Variables**: Standard variables applied to each tenant
- **Process Management**: Navigator handles Rails application lifecycle
